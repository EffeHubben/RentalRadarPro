...
def test_direct_scrapers_raise_blocked_when_browser_fetch_returns_no_html() -> None:
    ...
    original_marktplaats_fetch = marktplaats_scraper.fetch_page_with_browser
    ...
    try:
        ...
        marktplaats_scraper.fetch_page_with_browser = lambda *args, **kwargs: None
        ...
        try:
            marktplaats_scraper.fetch_marktplaats_listings("Breda")
            assert False, "Expected Marktplaats scraper to raise SourceBlockedError"
        except SourceBlockedError:
            pass
    finally:
        ...
        marktplaats_scraper.fetch_page_with_browser = original_marktplaats_fetch
