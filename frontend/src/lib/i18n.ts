...
export const i18n = {
  nl: {
    ...
    accountPage: {
      ...
      upgradeBody:
        "E-mailnotificaties bij nieuwe woningen, prioriteitstoegang tot nieuwe bronnen en geavanceerde filters voor serieuze woningzoekers.",
  ...
  en: {
    ...
    accountPage: {
      ...
      upgradeTitle: "RentScout Pro",
      upgradeBody:
        "Email alerts for new listings, priority access to new sources and advanced filters for serious renters.",
