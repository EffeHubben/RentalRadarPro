...
const copy = languageRecord(
  {
    ...
    intro:
      "Niet alleen woningen vinden. Ook beter reageren. Maak één keer je huurdersprofiel aan en genereer daarna per woning een nette reactie voor de verhuurder.",
    freePlanName: "Gratis",
    freePlanPrice: "€0",
    ...
    paddleIncluded: [
      ...
      "AI Reactie-assistent",
      "Huurdersprofiel",
      "Motivatiebericht per woning",
      "Documenten-checklist",
      "Houd overzicht over je reacties",
    ],
    ...
    proPlanFeatures: [
      ...
      "Opgeslagen zoekprofielen",
      "Workflow en statustracking per woning",
      "AI Reactie-assistent en motivatiebericht per woning",
    ],
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Pro geeft volledige toegang tot advertentiedetails, meer resultaten, geavanceerde filters, opgeslagen zoekprofielen, workflowtracking en de AI Reactie-assistent.",
      },
      {
  ...
  },
  {
    ...
    intro:
      "Not just finding homes. Respond better too. Create your tenant profile once, then generate a polished response for each listing.",
    freePlanName: "Free",
    freePlanPrice: "€0",
    ...
    paddleIncluded: [
      ...
      "Tenant profile",
      "Rental application message per listing",
      "Document checklist",
    ...
    proPlanFeatures: [
      ...
      "AI Response Assistant and per-listing application message",
    ],
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Pro gives full access to listing details, more results, advanced filters, saved search profiles, workflow tracking, and the AI Response Assistant.",
      },
      {
